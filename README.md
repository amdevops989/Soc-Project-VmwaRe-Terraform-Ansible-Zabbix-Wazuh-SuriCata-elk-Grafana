...
# 1. Define the default pool if it's missing entirely
sudo virsh pool-define-as default dir --target /var/lib/libvirt/images

# 2. Start the pool active runtime layer
sudo virsh pool-start default

# 3. Configure it to auto-start whenever your system boots up
sudo virsh pool-autostart default

# 4. Verify it shows as "active" and "autostarted"
sudo virsh pool-list --all# Soc-Project-VmwaRe-Terraform-Ansible-Zabbix-Wazuh-SuriCata-elk-Grafana
